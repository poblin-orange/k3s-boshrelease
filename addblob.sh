#!/bin/bash
wget https://github.com/k3s-io/k3s/releases/download/v1.19.4%2Bk3s1/k3s -O src/k3s
...
wget https://github.com/derailed/k9s/releases/download/v0.24.1/k9s_Linux_x86_64.tar.gz -O src/k9s_Linux_x86_64.tar.gz
cd src
