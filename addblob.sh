#!/bin/bash
wget https://github.com/rancher/k3s/releases/download/v1.19.3%2Bk3s3/k3s -O src/k3s
bosh add-blob src/k3s k3s/k3s

wget https://github.com/rancher/k3s/releases/download/v1.19.3%2Bk3s3/k3s-airgap-images-amd64.tar -O src/k3s-airgap-images-amd64.tar
